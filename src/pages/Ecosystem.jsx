...
const EXAMPLES = [
  { phase: 'Growth', media: [{ type: 'ig', src: 'https://www.instagram.com/p/DYjIuzFR-0-/embed', title: 'Cucina Moon Reel' }], links: [{ label: 'Cucina Moon', href: 'https://www.instagram.com/p/DYjIuzFR-0-/' }, { label: 'Supreme Dumplings', href: 'https://www.instagram.com/p/DaB-Pj2xpbx/' }] },
  { phase: 'Reach', media: [{ type: 'yt', thumb: 'https://img.youtube.com/vi/ld4I4f8DILA/maxresdefault.jpg', href: 'https://www.youtube.com/watch?v=ld4I4f8DILA&t=16s', title: 'Farm Lovers Markets' }], links: [{ label: 'Farm Lovers Markets', href: 'https://www.youtube.com/watch?v=ld4I4f8DILA&t=16s' }] },
