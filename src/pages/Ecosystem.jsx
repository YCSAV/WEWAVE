...
const EXAMPLES = [
  { phase: 'Growth', media: [{ type: 'ig', src: 'https://www.instagram.com/p/DYjIuzFR-0-/embed', title: 'Cucina Moon Reel' }, { type: 'ig', src: 'https://www.instagram.com/p/DagVxgcydms/embed', title: 'Slice of Hawaiʻi Reel' }], links: [{ label: 'Cucina Moon', href: 'https://www.instagram.com/p/DYjIuzFR-0-/' }, { label: 'Supreme Dumplings', href: 'https://www.instagram.com/p/DaB-Pj2xpbx/' }, { label: 'Slice of Hawaiʻi', href: 'https://www.instagram.com/p/DagVxgcydms/' }] },
  ...
  { phase: 'Optimization', media: [{ type: 'ig', src: 'https://www.instagram.com/p/DaB-Pj2xpbx/embed', title: 'Supreme Dumplings Reel' }, { type: 'yt', thumb: 'https://img.youtube.com/vi/Yyh1HHAIAQY/maxresdefault.jpg', href: 'https://www.youtube.com/watch?v=Yyh1HHAIAQY&t=642s', title: 'Rigo' }], links: [{ label: 'Short-form example', href: 'https://www.instagram.com/p/DaB-Pj2xpbx/' }, { label: 'Long-form example', href: 'https://www.youtube.com/watch?v=Yyh1HHAIAQY&t=642s' }] },
];
